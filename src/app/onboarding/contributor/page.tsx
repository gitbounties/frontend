        ...
        >
          ...
          {!isAuthenticated ? (
            <button
              ...
              className="text-white bg-gradient-to-br shadow-xl  from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-8 py-2.5 text-center mr-2 mb-2"
              style={{
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
